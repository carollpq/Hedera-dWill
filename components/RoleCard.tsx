...
export default function RoleCard({title, src, alt, btnText, status, className = ''}: RoleCardProps) {
    return (
        <div data-property-1="Role Card"
             ...
             inline-flex justify-start items-center gap-2 hover:cursor-pointer">
            <div className="w-72 inline-flex flex-col justify-start items-center gap-7">
                <div
                    className="self-stretch text-center justify-start text-white text-4xl font-normal font-['Newsreader']">{title}
                </div>
